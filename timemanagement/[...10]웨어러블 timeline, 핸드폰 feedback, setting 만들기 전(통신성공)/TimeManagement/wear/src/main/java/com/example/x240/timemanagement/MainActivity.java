...
public class MainActivity extends Activity
    ...
    LinearLayout progressLinear, doFinishLinear, mainLinear;                    //for progressBar
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(action == motionEvent.ACTION_DOWN) {
                    if(wearDB.getString("workName", null).equals("Nothing")) {
                        ...
                        if(wearDB.getString("workName", null).equals("Study") || wearDB.getString("workName", null).equals("Self Development") || wearDB.getString("workName", null).equals("Leisure") || wearDB.getString("workName", null).equals("Exercise") || wearDB.getString("workName", null).equals("Breathe") || wearDB.getString("workName", null).equals("Napping") || wearDB.getString("workName", null).equals("Sleeping")) {   //etc 일을 한 경우
                            //database에 추가해줘야
                            ...
                            //확인메시지, 테스트 완료. 잘 됨!
                            Toast.makeText(getApplicationContext(), "Etc Work Done!", Toast.LENGTH_SHORT).show();
                            ...
                            doingButton.setOnTouchListener(new View.OnTouchListener() {
                                ...
                                public boolean onTouch(View view, MotionEvent motionEvent) {
                                    int action2 = motionEvent.getAction();
                                    if (action2 == motionEvent.ACTION_DOWN) {
                                        sendDataStringForChangeData(YearMonthDay, wearDB.getString("workName", null), 1, wearDB.getString("workStartTime", null), HourMin);
                            ...
                            doneButton.setOnTouchListener(new View.OnTouchListener() {
                                ...
                                public boolean onTouch(View view, MotionEvent motionEvent) {
                                    int action2 = motionEvent.getAction();
                                    if (action2 == motionEvent.ACTION_DOWN) {
                                        sendDataStringForChangeData(YearMonthDay, wearDB.getString("workName", null), 2, wearDB.getString("workStartTime", null), HourMin);
    ...
    //인자 : DATE, TODO, TODOCHECK, ACTSTARTTIME, ACTENDTIME
    public void sendDataStringForChangeData(String date, String todo, int todocheck, String actStartTime, String actEndTime) {
        // 모바일로 전송할 데이터 묶음인 데이터 맵을 생성한다.
        ...
        dataMap.getDataMap().putInt("TODOCHECK", todocheck);
        dataMap.getDataMap().putString("ACTSTARTTIME", actStartTime);
        dataMap.getDataMap().putString("ACTENDTIME", actEndTime);
                    ...
                    for(int i = 0; i < dataCount; i++) {
                        ...
                        if(tmpCheckBoxArray.get(i) != 10) {
                            try {   //for show to-do
                                ...
                                Date startTime = formatter.parse(oneTodoData.get(0) + " " + oneTodoData.get(3));
                                Date endTime = formatter.parse(oneTodoData.get(0) + " " + oneTodoData.get(4));
