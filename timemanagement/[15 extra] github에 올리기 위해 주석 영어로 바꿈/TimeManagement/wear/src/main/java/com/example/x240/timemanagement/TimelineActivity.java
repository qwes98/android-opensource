 ...
 * Author : Jiwon Park
 * This is TimelineAcitvity for wearable. you can check todo timeline.
 */
...
public class TimelineActivity extends Activity {
    ...
    public void getTimeline() {
        ...
        for (int i = 0; i < dataCount; i++) {
            if(MainActivity.checkBoxArray.get(i) == 0 || MainActivity.checkBoxArray.get(i) == 1 || MainActivity.checkBoxArray.get(i) == 2) {    // Exclude etc, add work
